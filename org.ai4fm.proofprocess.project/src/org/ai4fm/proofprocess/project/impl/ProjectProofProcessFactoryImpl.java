...
public class ProjectProofProcessFactoryImpl extends EFactoryImpl implements ProjectProofProcessFactory {
	...
	public static ProjectProofProcessFactory init() {
		try {
			ProjectProofProcessFactory theProjectProofProcessFactory = (ProjectProofProcessFactory)EPackage.Registry.INSTANCE.getEFactory("http://org/ai4fm/proofprocess/project/v1.0.0.13"); 
