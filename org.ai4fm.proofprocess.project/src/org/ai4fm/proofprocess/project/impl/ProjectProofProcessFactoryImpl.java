...
public class ProjectProofProcessFactoryImpl extends EFactoryImpl implements ProjectProofProcessFactory {
	...
	public static ProjectProofProcessFactory init() {
		try {
			ProjectProofProcessFactory theProjectProofProcessFactory = (ProjectProofProcessFactory)EPackage.Registry.INSTANCE.getEFactory(ProjectProofProcessPackage.eNS_URI);
