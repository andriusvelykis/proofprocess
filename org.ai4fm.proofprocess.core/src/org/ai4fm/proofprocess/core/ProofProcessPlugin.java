...
public class ProofProcessPlugin extends Plugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.ai4fm.proofprocess.core"; //$NON-NLS-1$
	
	// The shared instance
	private static ProofProcessPlugin plugin;
	 ...
	 */
	public static ProofProcessPlugin getDefault() {
		return plugin;
	}
