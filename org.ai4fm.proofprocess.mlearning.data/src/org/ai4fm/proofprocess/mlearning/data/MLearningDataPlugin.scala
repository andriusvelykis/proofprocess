package org.ai4fm.proofprocess.mlearning.data
...
/**
  ...
  */
object MLearningDataPlugin {

  // The shared instance
  private var instance: MLearningDataPlugin = _
  def plugin = instance
...
class MLearningDataPlugin extends Plugin {

  MLearningDataPlugin.instance = this
  
  // The plug-in ID
  def pluginId = "org.ai4fm.proofprocess.mlearning.data" //$NON-NLS-1$
