...
public class IsabelleProofProcessAdapterFactory extends AdapterFactoryImpl {
	...
	protected IsabelleProofProcessSwitch<Adapter> modelSwitch =
		new IsabelleProofProcessSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNamedTerm(NamedTerm object) {
				return createNamedTermAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseAssumptionTerm(AssumptionTerm object) {
				return createAssumptionTermAdapter();
			}
			@Override
			public Adapter caseJudgementTerm(JudgementTerm object) {
				return createJudgementTermAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.ai4fm.proofprocess.isabelle.MarkupTerm <em>Markup Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.ai4fm.proofprocess.isabelle.NamedTerm <em>Named Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.ai4fm.proofprocess.isabelle.AssumptionTerm <em>Assumption Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.ai4fm.proofprocess.isabelle.JudgementTerm <em>Judgement Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
